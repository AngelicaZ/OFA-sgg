...
import numpy as np
from fairseq.fairseq import tokenizer, utils
from fairseq.fairseq.data import ConcatDataset, Dictionary, TokenBlockDataset, data_utils
from fairseq.fairseq.data.legacy.masked_lm_dataset import MaskedLMDataset
from fairseq.fairseq.data.legacy.masked_lm_dictionary import MaskedLMDictionary
from fairseq.fairseq.data.multi_corpus_sampled_dataset import MultiCorpusSampledDataset
